...
config = {
    ...
    "gamma": 0.80,  # One of the most important. Tune this!
...
ray.tune.run(
    ...
    restore="/home/ray/ray_results/big-one/PPO_TensorGrowthEnvironment_bc3f9_00000_0_2021-05-08_12-36-50/checkpoint_000030/checkpoint-30",
    )
